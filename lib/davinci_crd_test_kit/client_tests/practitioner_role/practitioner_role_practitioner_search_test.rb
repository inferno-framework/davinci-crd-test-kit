...
[US Core Server CapabilityStatement](http://hl7.org/fhir/us/core/STU3.1.1/CapabilityStatement-us-core-server.html)
    ...
    id :crd_client_fhir_api_practitioner_role_practitioner_search_test
    output :practitioner_role_id_with_practitioner
    def self.properties
    ...
    run do
      ...
      practitioner_role_id_with_practitioner = search_response_bundle.entry&.first&.resource&.id
      output(practitioner_role_id_with_practitioner:)
    end
  end
end
