  ...
  module V221
    class LaunchSmartAppCardValidationTest < Inferno::Test
      ...
      description %(
        ...
        As per the [Da Vinci CRD Implementation Guide](https://hl7.org/fhir/us/davinci-crd/2.2.1/en/cards.html#launch-smart-application-response-type),
      ...
      run do
        ...
        skip_if launch_smart_app_cards.blank?,
                "#{tested_hook_name} hook response does not contain any Launch SMART Application cards."
        ...
        assert messages.blank?,
               'Not all Launch SMART Application cards were valid. See messages for more information.'
      end
    end
  end
end
