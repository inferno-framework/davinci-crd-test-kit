  ...
  module V221
    class ServerHooksGroup < Inferno::TestGroup
      ...
      description %(
        ...
        The #{title} Group verifies that a [CRD Server](https://hl7.org/fhir/us/davinci-crd/2.2.1/en/CapabilityStatement-crd-server.html)
        supports at least one of the hooks supported by the [CRD IG](https://hl7.org/fhir/us/davinci-crd/2.2.1/en/hooks.html).
        ...
        The [CRD v2.2.1 IG section on Supported Hooks](https://hl7.org/fhir/us/davinci-crd/2.2.1/en/hooks.html)
        ...
        In these tests, Inferno acts as a [CRD Client](https://hl7.org/fhir/us/davinci-crd/2.2.1/en/ActorDefinition-crd-client.html)
        ...
        - Each [CRD response type](https://hl7.org/fhir/us/davinci-crd/2.2.1/en/cards.html#potential-crd-response-types)
