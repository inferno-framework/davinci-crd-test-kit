...
module DaVinciCRDTestKit
  module V220
    class ServerHooksGroup < Inferno::TestGroup
      ...
      group from: :crd_v220_server_appointment_book,
            optional: true
      group from: :crd_v220_server_encounter_start,
            optional: true
      group from: :crd_v220_server_encounter_discharge,
            optional: true
      group from: :crd_v220_server_order_select,
            optional: true
      group from: :crd_v220_server_order_dispatch,
            optional: true
      group from: :crd_v220_server_order_sign,
            optional: true
      group from: :crd_v220_server_required_card_response_validation
    end
  end
end
