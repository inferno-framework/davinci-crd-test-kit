...
require_relative 'client_card_must_support_group'
...
module DaVinciCRDTestKit
  module V220
    class CRDClientSuite < Inferno::TestSuite
      id :crd_client_v220
      title 'Da Vinci CRD Client v2.2.0 Test Suite'
      description <<~DESCRIPTION
        The Da Vinci CRD Client Test Suite tests the conformance of client systems
        to [version 2.2.0 of the Da Vinci Coverage Requirements Discovery (CRD)
      ...
      group do
        id :crd_v220_client_hook_invocation
        ...
        group from: :crd_v220_client_registration
        group from: :crd_v220_client_hooks
        group from: :crd_v220_client_card_must_support
      end

      group from: :crd_v220_client_fhir_api
    end
  end
end
