...
require_relative 'api/client_fhir_api_read_test'
require_relative 'api/client_fhir_api_search_test'
require_relative 'api/client_fhir_api_create_test'
require_relative 'api/client_fhir_api_update_test'
require_relative 'api/client_fhir_api_validation_test'
    ...
    class ClientFHIRAPIGroup < Inferno::TestGroup
      ...
      group do
        ...
        group from: :smart_discovery do
          required_suite_options CRDClientOptions::SMART_1_REQUIREMENT
          run_as_group
          ...
          test from: :tls_version_test do
            ...
            DESCRIPTION
            id :crd_v220_server_tls_version_stu1
        ...
        group from: :smart_discovery_stu2 do
          required_suite_options CRDClientOptions::SMART_2_REQUIREMENT
          run_as_group
      ...
      group do
        ...
        group do
          ...
          test from: :crd_v220_client_fhir_api_search_test,
               id: :crd_v220_client_coverage_patient_search_test,
          ...
          test from: :crd_v220_client_fhir_api_search_test,
               id: :crd_v220_client_coverage_status_search_test,
          ...
          test from: :crd_v220_client_fhir_api_validation_test,
               config: {
        ...
        group do
          ...
          test from: :crd_v220_client_fhir_api_read_test,
               optional: true,
               config: {
        ...
        group do
          ...
          test from: :crd_v220_client_fhir_api_search_test,
               id: :crd_v220_client_encounter_id_search_test,
               title: 'Search by _id',
               config: {
          ...
          test from: :crd_v220_client_fhir_api_search_test,
               id: :crd_v220_client_encounter_organization_search_test,
          ...
          test from: :crd_v220_client_fhir_api_search_test,
               id: :crd_v220_client_encounter_location_include_test,
        ...
        group do
          ...
          test from: :crd_v220_client_fhir_api_search_test,
               id: :crd_v220_client_practitioner_role_id_search_test,
               title: 'Search by _id',
               config: {
          ...
          test from: :crd_v220_client_fhir_api_search_test,
               id: :crd_v220_client_practitioner_role_organization_search_test,
               title: 'Search by organization',
               config: {
          ...
          test from: :crd_v220_client_fhir_api_search_test,
               id: :crd_v220_client_practitioner_role_practitioner_search_test,
          ...
          test from: :crd_v220_client_fhir_api_search_test,
               id: :crd_v220_client_practitioner_role_organization_include_test,
          ...
          test from: :crd_v220_client_fhir_api_search_test,
               id: :crd_v220_client_practitioner_role_practitioner_include_test,
        ...
        group do
          ...
          test from: :crd_v220_client_fhir_api_create_test,
               optional: true,
               config: {
