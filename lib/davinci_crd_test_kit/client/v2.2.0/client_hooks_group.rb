  ...
  module V220
    class ClientHooksGroup < Inferno::TestGroup
      ...
      description <<~DESCRIPTION
        ...
        * If the hook response generated by Inferno is conformant.
        * If the client can properly display the cards returned as a result of the hook request

        Note: In order to successfully return a conformant `Coverage Information` system action, a Coverage resource must either be
      ...
      group from: :crd_v220_client_appointment_book,
            optional: true

      group from: :crd_v220_client_encounter_start,
            optional: true

      group from: :crd_v220_client_encounter_discharge,
            optional: true

      group from: :crd_v220_client_order_select,
            optional: true

      group from: :crd_v220_client_order_dispatch,
            optional: true

      group from: :crd_v220_client_order_sign,
            optional: true
    end
  end
end
