...
module DaVinciCRDTestKit
  module V220
    class ClientCardMustSupportGroup < Inferno::TestGroup
      ...
      id :crd_v220_client_card_must_support
      ...
      test from: :crd_v220_client_card_must_support_coverage_information
      test from: :crd_v220_client_card_must_support_external_reference
      test from: :crd_v220_client_card_must_support_instructions
    end
  end
end
