  ...
  module V201
    class HookRequestOptionalFieldsTest < Inferno::Test
      ...
      description %(
        ...
        requires that a CDS service request SHALL include a JSON POST body which MAY contain the following
      ...
      run do
        ...
        requests.each_with_index do |request, index|
          ...
          fhir_server_info = hook_request_optional_fields_check(request_body, ig_version: 'v201')
