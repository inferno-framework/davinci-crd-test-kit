...
module DaVinciCRDTestKit
  ...
  APPOINTMENT_BOOK_PREFETCH_SUBSET_PATH = "#{PREFETCH_SUBSET_PREFIX}#{APPOINTMENT_BOOK_PATH}".freeze
  ENCOUNTER_START_PREFETCH_SUBSET_PATH = "#{PREFETCH_SUBSET_PREFIX}#{ENCOUNTER_START_PATH}".freeze
  ENCOUNTER_DISCHARGE_PREFETCH_SUBSET_PATH = "#{PREFETCH_SUBSET_PREFIX}#{ENCOUNTER_DISCHARGE_PATH}".freeze
  ORDER_DISPATCH_PREFETCH_SUBSET_PATH = "#{PREFETCH_SUBSET_PREFIX}#{ORDER_DISPATCH_PATH}".freeze
  ORDER_SELECT_PREFETCH_SUBSET_PATH = "#{PREFETCH_SUBSET_PREFIX}#{ORDER_SELECT_PATH}".freeze
  ORDER_SIGN_PREFETCH_SUBSET_PATH = "#{PREFETCH_SUBSET_PREFIX}#{ORDER_SIGN_PATH}".freeze
