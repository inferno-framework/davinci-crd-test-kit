require_relative '../../../../../lib/davinci_crd_test_kit/client/v2.0.1/invocation/appointment_book_receive_request_test' # rubocop:disable Layout/LineLength

RSpec.describe DaVinciCRDTestKit::V201::AppointmentBookReceiveRequestTest, :request do
  ...
  before do
    ...
    allow_any_instance_of(DaVinciCRDTestKit::HookRequestEndpoint).to receive_messages(gather_appointment_book_data: nil,
