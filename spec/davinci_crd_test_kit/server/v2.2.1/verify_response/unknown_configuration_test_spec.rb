require_relative '../../../../../lib/davinci_crd_test_kit/server/v2.2.1/verify_response/unknown_configuration_test'

RSpec.describe DaVinciCRDTestKit::V221::UnknownConfigurationTest do
  ...
  def create_service_request(
    ...
    repo_create(
      ...
      request_body: unknown_configuration_request_body.to_json,
  ...
  def create_unknown_configuration_request(**args)
    create_service_request(
      **args,
      tags: [DaVinciCRDTestKit::ORDER_SIGN_TAG, DaVinciCRDTestKit::UNKNOWN_CONFIGURATION_TAG]
    )
  end

  def unknown_configuration_request_body
  ...
  it 'passes when unknown configuration responses include coverage-info' do
    create_unknown_configuration_request(body: original_response)
  ...
  it 'fails if the unknown response does not contain coverage-info' do
    create_unknown_configuration_request(body: filtered_response)
